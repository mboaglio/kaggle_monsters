...
directorio_trabajo    <- "/Users/marcos/odrive/ITBA/Kaggle/monsters/XGBoostFE1"  
...
dataset_unido$color <- NULL  # Saco el color que jode
dataset_unido$id <- NULL # Saco el id
# dataset$rotting_flesh # Lo dejo como esta
dataset_unido$V1 <- (dataset_unido$bone_length + dataset_unido$hair_length + dataset_unido$has_soul) / 3
